...
export default function SchedulerPage() {
    ...
    useEffect(() => {
        ...
        loadTopics()
        loadExports()
    }, [authReady, loadTasks, loadTopics, loadExports])
                        ...
                        {scheduleType === 'once' && (
                            <div>
                                ...
                                <input
                                    ...
                                    className="border border-slate-300 rounded-lg px-3 py-2.5 text-slate-800 text-sm focus:outline-none focus:border-teal-500"
                                />
                            </div>
                        )}
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-slate-800 text-sm focus:outline-none focus:border-teal-500"
                                    >
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full border border-slate-300 rounded-lg px-3 py-2 text-slate-800 text-sm focus:outline-none focus:border-teal-500 resize-none"
                                    />
                                </div>
                            </div>
                        )}
